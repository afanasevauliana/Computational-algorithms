...
def merge_sort_animated(arr, x=0, y=0, level=0, max_depth=None):
    ...
    left_result, left_max_level, left_final_x, left_final_y = merge_sort_animated(
    ...
    right_result, right_max_level, right_final_x, right_final_y = merge_sort_animated(
    ...
    # ===== СТРЕЛКИ ОТ РЕЗУЛЬТАТОВ ДЕТЕЙ (а не от исходных позиций) =====
    frames.append({
        'type': 'edge',
...
sorted_arr, _, _, _ = merge_sort_animated(array, x=0, y=10, max_depth=max_depth)
